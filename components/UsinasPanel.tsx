      ...
      <div className="h-full grid grid-cols-1 md:grid-cols-2 overflow-y-auto md:overflow-hidden">
        ...
        <div className="flex flex-col justify-center px-10 py-16 md:px-12
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[9px] font-medium tracking-[.28em] uppercase text-green">
              Produção Própria
            </span>
          </div>
          ...
          <p className="text-[13px] font-light leading-[1.85] text-white/45 mt-7 max-w-[380px]">
            ...
            {usinas.map(u => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-display font-bold text-[16px] tracking-[.08em] uppercase text-white">
                    {u.name}
                  </div>
                  <div className="text-[10px] text-white/30 mt-0.5 tracking-[.04em]">
                    {u.location}
                  </div>
                </div>
        ...
        <div className="flex flex-col justify-center px-10 py-16 md:px-12">
          ...
          <div className="flex flex-col">
            {specs.map((s, i) => (
              ...
              >
                <span className="text-[11px] font-normal tracking-[.04em] text-white/30">
                  {s.key}
                </span>
                <span className="font-display font-bold text-[18px] text-white tracking-[.04em]">
                  {s.value}
                  {s.sub && (
                    <small className="text-[11px] text-green ml-1">{s.sub}</small>
                  )}
                </span>
              </div>
            ))}
          ...
          <div className="mt-8 px-5 py-5 bg-white/[.04] border-l-[3px] border-green">
            <p className="text-[12px] font-light leading-[1.75] text-white/45">
