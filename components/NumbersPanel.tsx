    ...
    <section className="panel bg-cream" id="p2">
      <div className="h-full flex flex-col justify-center px-6 md:px-12 relative">
        ...
        <div className="flex items-center gap-4 mb-10">
          <span className="text-[12px] font-medium tracking-[.2em] uppercase text-navy/40">
            {company.name}
          </span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-0">
          {numbers.map((n, i) => (
            <div key={i}
              ...
              <span className="text-[14px] font-normal tracking-[.03em] text-navy/50
                mt-2 whitespace-pre-line leading-snug">
                {n.label}
              </span>
            </div>
          ))}
        ...
        <div className="absolute bottom-10 left-6 right-6 md:left-12 md:right-12
          ...
          <span className="text-[11px] font-medium tracking-[.14em] uppercase text-navy/30">
            {company.address}
          </span>
