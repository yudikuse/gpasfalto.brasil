...
// SVG WhatsApp oficial (não usar lucide pra ficar fiel à marca WhatsApp)
...
export function WhatsAppFloat() {
  ...
  return (
    ...
    >
      {/* Painel com lista de telefones */}
      <div
        className={cn(
          'absolute bottom-full right-0 mb-3 w-72 origin-bottom-right transition-all duration-300 ease-out-expo',
          open
      ...
      {/* Botão flutuante (sempre verde WhatsApp) */}
      <button
        onClick={() => setOpen(!open)}
        aria-label={open ? 'Fechar contatos WhatsApp' : 'Abrir contatos WhatsApp'}
        className={cn(
